...
pub contract superflo1: NonFungibleToken {
  ...
  pub resource NFT: NonFungibleToken.INFT {
    ...
    init(_ipfsHash: String, _metadata: {String: String}) {
      self.id = superflo1.totalSupply
      superflo1.totalSupply = superflo1.totalSupply + 1
  ...
  pub resource interface CollectionPublic {
    pub fun borrowEntireNFT(id: UInt64): &superflo1.NFT
  }
  ...
  pub resource Collection: NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, CollectionPublic {
    ...
    pub fun deposit(token: @NonFungibleToken.NFT) {
      let myToken <- token as! @superflo1.NFT
    ...
    pub fun borrowEntireNFT(id: UInt64): &superflo1.NFT {
      ...
      return reference as! &superflo1.NFT
    }
  ...
  pub fun createToken(ipfsHash: String, metadata: {String: String}): @superflo1.NFT {
