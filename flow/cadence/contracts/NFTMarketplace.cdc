...
import superflo1 from 0x4afc162bce5d7fb4 // First deployed this
import FungibleToken from 0x9a0766d93b6608b7 //Document
import FlowToken from  0x7e60df042a9c0868 //Document

pub contract supermarketplace1 {

  pub struct SaleItem {
    pub let price: UFix64
    
    pub let nftRef: &superflo1.NFT
    
    init(_price: UFix64, _nftRef: &superflo1.NFT) {
      self.price = _price
      self.nftRef = _nftRef
    }
  }
  ...
  pub resource interface SaleCollectionPublic {
    ...
    pub fun purchase(id: UInt64, recipientCollection: &superflo1.Collection{NonFungibleToken.CollectionPublic}, payment: @FlowToken.Vault)
  }
  ...
  pub resource SaleCollection: SaleCollectionPublic {
    ...
    pub let SuperCoolCollection: Capability<&superflo1.Collection>
    ...
    init(_SuperCoolCollection: Capability<&superflo1.Collection>, _FlowTokenVault: Capability<&FlowToken.Vault{FungibleToken.Receiver}>) {
      self.forSale = {}
  ...
  pub fun createSaleCollection(SuperCoolCollection: Capability<&superflo1.Collection>, FlowTokenVault: Capability<&FlowToken.Vault{FungibleToken.Receiver}>): @SaleCollection {
